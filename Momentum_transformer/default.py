...
CPD_QUANDL_OUTPUT_FOLDER = lambda lbw: os.path.join(
    "/home/tao/transformer/resive_trading-momentum-transformer/data/", f"cpd_{(lbw if lbw else 'none')}"
)
...
FEATURES_QUANDL_FILE_PATH = lambda lbw: os.path.join(
    "/home/tao/transformer/resive_trading-momentum-transformer/data", f"quandl_cpd_{(lbw if lbw else 'none')}lbw.csv"
)
